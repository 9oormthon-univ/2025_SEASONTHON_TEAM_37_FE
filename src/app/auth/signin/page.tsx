...
import { signIn, SignInPayload } from '@/apis/services/auth';
import { z } from 'zod';
...
const SignInPage = () => {
  ...
  return (
    <div className="px-4 justify-center size-full flex-1 flex flex-col items-center gap-4 max-w-lg m-auto">
      ...
      <p className="text-gray-600">여기서부터 귀하의 다음 스텝이 이어집니다</p>
      ...
      >
        ...
        <p className="text-gray-600 text-sm text-center">
          아직 회원이 아니신가요?{' '}
          <Link href={PATH.auth.signUp} className="text-primary underline">
            회원가입
          </Link>
        </p>
      </form>
